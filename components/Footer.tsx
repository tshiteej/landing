...
export default function Footer() {
  return (
    <footer className="bg-background-light border-t border-white/5 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-500 mb-4 leading-relaxed max-w-xs">
              The AI knowledge assistant for modern SaaS teams. Turn documentation into conversations.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              ...
              <li>
                <Link className="hover:text-primary transition-colors" href="/terms-and-conditions">
                  Terms
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6">
            ...
            <Link className="text-gray-500 hover:text-white transition-colors" href="#" aria-label="GitHub">
